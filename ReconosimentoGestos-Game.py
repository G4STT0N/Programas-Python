...
webbrowser.open('game.html') # LINK DEL JUEGO
...
SCREEN_GAME_X_INI = 250
SCREEN_GAME_Y_INI = 260
SCREEN_GAME_X_FIN = 250 + 780
SCREEN_GAME_Y_FIN = 260 + 450

aspect_ratio_screen = (SCREEN_GAME_X_FIN - SCREEN_GAME_X_INI) / (SCREEN_GAME_Y_FIN - SCREEN_GAME_Y_INI)
print("Aspecto de la Pantalla = ", aspect_ratio_screen)
